            ...
            <div class="container-fluid colorblue">
				<div class="container">
					<div class="row">
						...
						<p class="textwhite text-center">SportTeams é um site criado para pessoas que tem a necessidade de achar um time para participar de
						campeonatos ou até mesmo encontrar jogadores para o seu time. Foi criado após uma necessesidade de um dos desenvolvedores de achar um time
						para participar de um campeonato, então foi desenvolvida esta ferramenta para suprir a necessidade de nós, atletas.</p>
						
						<p class="text-center"><a href="#"><i class="fa fa-facebook-square textwhite" style="font-size:50px !important;"></i></a>;&nbsp;;&nbsp;;&nbsp;
                  ...
                  <div class="col-sm-6 col-md-4">
                    <div class="thumbnail thumbnail-inverse container-sport">
                      ...
                      <div class="caption">
						...
						<br/>
						<p class="text-center"><a href="#" class="btn btn-default" role="button">Jogadores</a> <a href="#" class="btn btn-default" role="button">Times</a></p>
                      </div>
                    </div>
                  </div>
