                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                  ...
                  <ul class="nav navbar-nav">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="jogadores_volei.php"><i class="fa fa-angle-double-right iconcolorblue"></i> Voleibol</a></li>
                        <li><a href="jogadores_futebol.php"><i class="fa fa-angle-double-right iconcolorblue"></i> Futebol</a></li>
                        <li><a href="jogadores_basquete.php"><i class="fa fa-angle-double-right iconcolorblue"></i> Basquete</a></li>
                      </ul>
                      </li>
                    ...
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="profile.php"><i class="fa fa-user-circle iconcolorblue"></i> Seu Perfil</a></li>
                        <li><a href="#"><i class="fa fa-pencil iconcolorblue"></i> Editar Perfil</a></li>
                        <li><a href="profile_time.php"><i class="fa fa-users iconcolorblue"></i> Seu Time</a></li>
                        <li><a href="times_criacao.php"><i class="fa fa-plus iconcolorblue"></i> Criar Time</a></li>
                        <li class="divider"></li>
                  ...
                  <ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
					  ...
					  <ul class="dropdown-menu login-panel">
                        ...
                        <?php } else {    ?>
                            <ul class="nav navbar-nav navbar-right">
                                <li style="margin-top:14px; color:white;">Logado como: <?php echo $usuarioNome;?></li>
                            </ul>
                        <?php  }  ?>
                </div>
            </nav>
